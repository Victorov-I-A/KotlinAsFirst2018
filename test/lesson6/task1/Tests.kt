...
class Tests {
    ...
    fun bestLongJump() {
        ...
        assertEquals(2147483647, bestLongJump("688841079  - 1894574572 % -  % 2147483647   -"))
    ...
    fun firstDuplicateIndex() {
        ...
        assertEquals(30, firstDuplicateIndex("~ \\ @ . T ! Q p K ; 8 L K 1 / K K 1 / K"))
        assertEquals(-1, firstDuplicateIndex("F ; @ ; @ , i"))
    }
    ...
    fun computeDeviceCells() {
        ...
        assertEquals(listOf(0, 0, 0), computeDeviceCells(3, "", 10))
